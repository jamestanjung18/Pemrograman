 ...
 void KOP ()
{
    ...
    cout<<"|                                                                               |"<<endl;
    cout<<"|                                 E-MINIMART                                    |"<<endl;
    cout<<"|                          Condong Catur no.198 Raya                            |"<<endl;
    cout<<"|                             admin@engineer.com                                |"<<endl;
    cout<<"|                                                                               |"<<endl;
...
int Input ()
{
   ...
   cout<<"  "<<endl;
   cout<<"Tekan ENTER(Y) untuk Melakukan Pembayaran !"<<endl;
   cout<<"  "<<endl;
   getch ();
}
void transaksi ()
{
   ...
   char jawab;
   cout<<"                 MENU TRANSAKSI E-MINIMART            "<<endl;
   cout<<"   1.Member    "<<endl;
